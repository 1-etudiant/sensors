...
#from models.modules.efficient import *
sys.path.append("home/sh/yolov5/models")
#from .modules.CA import *
#from .modules.efficient import *
#from .modules.deformable_LKA import *
#from .modules.GSconv import *
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
                ...
                BottleneckCSP, GSConv,C3,VoVGSCSP, C3_DLKA,LKA,conv_bn_relu_maxpool,Shuffle_Block,CBAM,CoordAtt,C3TR,C2f, C3cneb,C3SPP, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x,\
            ...
            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, C3, VoVGSCSP,C3cneb,C3TR, C3Ghost, C3x,C3_DLKA}:
                args.insert(2, n)  # number of repeats
                n = 1
        elif m in{ShuffleNetV2,efficientnet_v2}:
            m=m()
            c2=m.width_list
            backbone=True

        elif m in {deformable_LKA,res2DF_LKA,split_DLKA}:
            args=[ch[f],*args]
